...
### 🔍 市场情报分析 (可选模块)
- **支付流量发现**: 基于 Semrush API 的高价值域名发现
- **技术栈分析**: 基于 BuiltWith API 的精准支付能力识别
- **联系人发现**: 基于 Hunter API 的决策者联系方式获取
- **域名情报**: 基于 Whois 数据的公司成熟度分析
- **用户行为分析**: 深度分析用户访问路径和转化关键点
- **竞争对手分析**: 发现竞争对手的支付策略和市场机会
- **自动化工作流**: 批量分析和报告生成
...
| `npm run setup-market-intelligence` | 安装市场情报分析模块 |
